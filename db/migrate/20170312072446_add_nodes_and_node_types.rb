class AddNodesAndNodeTypes < ActiveRecord::Migration
  def self.up
    ...
    NodeType.create :name => "Product", :totype => "System", :img_link => "/images/nodes/product.png"
    NodeType.create :name => "System", :totype => "System", :img_link => "/images/nodes/system.png"
    NodeType.create :name => "Parameter", :totype => "System", :img_link => "/images/nodes/param.png"
